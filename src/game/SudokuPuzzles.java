...
public enum SudokuPuzzles {
    ...
    private static int[][] getPuzzle3() {
        int[][] thePuzzle = new int[9][9];
        thePuzzle[0] = new int[] {0, 0, 0, 6, 0, 0, 4, 0, 0};
        thePuzzle[1] = new int[] {7, 0, 0, 0, 0, 3, 6, 0, 0};
        thePuzzle[2] = new int[] {0, 0, 0, 0, 9, 1, 0, 8, 0};
        thePuzzle[3] = new int[] {0, 0, 0, 0, 0, 0, 0, 0, 0};
        thePuzzle[4] = new int[] {0, 5, 0, 1, 8, 0, 0, 0, 3};
        thePuzzle[5] = new int[] {0, 0, 0, 3, 0, 6, 0, 4, 5};
        thePuzzle[6] = new int[] {0, 4, 0, 2, 0, 0, 0, 6, 0};
        thePuzzle[7] = new int[] {9, 0, 3, 0, 0, 0, 0, 0, 0};
        thePuzzle[8] = new int[] {0, 2, 0, 0, 0, 0, 1, 0, 0};
        return thePuzzle;
    }
}
